...
enum KEErrorCode{
    ...
    KE_IMGDECODE_ERROR=0x1002,//身份证照片解码失败
    
    KE_UnKnowType=0x1001,//不支持的协议类型
    KE_CHINAMOBILE_WRITECARD_FAILED=0x1002,//写卡失败
    
    
    OPS_SUCCESS = 0, //success
    OPS_DeviceNotFind = 1001, //设备未找到
    OPS_DeviceConnectFailed = 1002, //设备连接失败
    OPS_CardPowerOnFailed = 1003, //卡片上电失败
    OPS_APDUSendFailed = 1004,//APDU发送失败
    OPS_CardPowerOffFailed = 1005,
    OPS_APDUResponseError = 1006,//APDU响应错误
    OPS_ParamError = 1007,//参数错误
    OPS_WRITEDCARD = 1008,
    OPS_WRITECARDERROR = 1009,
    OPS_DeviceConnected = 1010,
    
    KE_APPID_ERROR=0x2001,//appid 错误
    KE_APPSECRET_ERROR=0x2002//appid对应的SecertKey请求错误
